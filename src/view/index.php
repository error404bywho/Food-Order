    ...
    <main>
        <article>
            <!-- 
             ...
             <section class="hero" id="home" style="background-image: url('../../assets/images/hero-bg.jpg');">
                <div class="container">
                    ...
                    <figure class="hero-banner">
                        <img src="../../assets/images/hero-banner-bg.png" 
                        width="820" height="716" loading="lazy" alt="" class="w-100 hero-img-bg">
                        <img src="../../assets/images/hero-banner.png" width="700"
                        height="637" loading="lazy" alt="" class="w-100 hero-img">
                    </figure>
             ...
             <section class="section section-divider gray about">
                <div class="container">
                    <div class="about-banner">
                        <img src="../../assets/images/about-banner.png" width="508"
                         height="459" loading="lazy" alt="Burgers with Drinks" class="w-100 about-img">

                         <img src="../../assets/images/sale-shape-red.png" width="216" height="226"
                          loading="lazy" alt="get off to 50% off now" class="abs-img scale-up-anim">
                    </div>
                    ...
                    <div class="about-content">
                        ...
                        <p class="section-text">
                            Welcome to <span class="span">MEATEATER</span>, Đà Nẵng’s go-to spot for fast, fresh, and delicious meals! We pride ourselves on serving up juicy burgers, crispy fries, and local favorites made with quality ingredients. Whether you're on the go or hanging out with friends, we’re here to bring you quick bites packed with flavor.
                        </p>
             ...
             <section class="section section-divider cta" style="background-image: url('../../assets/images/hero-bg.jpg');">
                <div class="container">
                    ...
                    <figure class="cta-banner">
                        ...
                        <img src="../../assets/images/cta-banner.png" width="700" 
                        height="637" loading="lazy" alt="" class="w-100 cta-img">

                        <img src="../../assets/images/sale-shape.png" width="216" 
            ...
            <section class="section section-divider gray delivery">
                <div class="container">
                    ...
                    <figure class="delivery-banner">
                        <img src="../../assets/images/delivery-banner-bg.png" 
                        class="w-100" width="700" height="602" alt="Clouds" 
                        loading="lazy">

                        <img src="../../assets/images/delivery-boy.svg" 
                    ...
                    <ul class="banner-list">
                        <li class="banner-item banner-lg">
                            <div class="banner-card">
                                <img src="../../assets/images/banner-1.jpg" width="550" height="450" 
                                loading="lazy" alt="Discount For Delicious Tasty Burgers!" class="banner-img">

                                <div class="banner-item-content">
                                    <p class="banner-subtitle">20% Sale Off !</p>

                                    <h3 class="banner-title">Discount for every weekend !</h3>

                                    <p class="banner-text">Sale off 20% in weekend </p>
                        ...
                        <li class="banner-item banner-sm">
                            <div class="banner-card">
                                <img src="../../assets/images/banner-2.jpg" width="550" height="460" 
                                loading="lazy" alt="Delicious Pizza" class="banner-img">

                                <div class="banner-item-content">
                                    <p class="banner-subtitle">Attractive vouchers !</p>

                                    <h3 class="banner-title">Best sales in Holiday </h3>

                                    <p class="banner-text">Atractive sale in Holiday </p>
                        ...
                        <li class="banner-item banner-sm">
                            <div class="banner-card">
                                <img src="../../assets/images/banner-3.jpg" width="550" height="465" 
                                loading="lazy" alt="American Burgers" class="banner-img">

                                <div class="banner-item-content">
                                    <p class="banner-subtitle">Best Seller !</p>

                                    <h3 class="banner-title">best Dishes</h3>

                                    <p class="banner-text">Sale more 10% for best seller of weeks</p>
 ...
 <!-- #region 
  -->
                                <div class="banner-item-content">
                                    ...
                                    <h3 class="banner-title">Patrons voucher</h3>

                                    <p class="banner-text">sale up to 30% for more 10 bills per week </p>
