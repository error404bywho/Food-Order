    ...
    if (isset($_POST) && isset($_POST["total"])) {
        ...
        if(is_numeric($order_total)) {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                header("Location: http://localhost/HOC_TAP/YEAR_2/DAW/sepay/order.php?id=" . $order_id);
...
<div class="row mt-5 px-2" id="checkout_box">
    ...
    <div class="col-md-6 border text-center p-2">
        ...
        <div class="my-2">
            <img src="https://qr.sepay.vn/img?bank=MBBank&acc=0905376235&template=compact&amount=<?= intval($order_details->total);?>&des=DH<?= $order_id;?>" class="img-fluid">
    ...
    <div class="col-md-6 border p-2">
        ...
        <table class="table">
            <tbody>
                <tr>
                    <td>Chủ tài khoản: </td>
                    <td><b>Lê Đình Vũ</b></td>
                </tr>
                 <tr>
                    <td>Số TK: </td>
                    <td><b>0905376235</b></td>
                </tr>
                 <tr>
                    <td>Số tiền: </td>
...
<div>
    <p class="mt-5"><a class="text-decoration-none" href="http://localhost/HOC_TAP/YEAR_2/DAW/sepay/order.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
